...
public class ManagePatient extends javax.swing.JFrame {
    ...
    public ManagePatient(javax.swing.JFrame parent, String userCode, String userRole) {
        this.parent = parent;
    ...
    private void loadPatients(int page) {
        ...
        String query = "SELECT * FROM patients LIMIT " + pageSize + " OFFSET " + offset;
        ...
        try (Connection conn = DBConnect.DatabaseConnection.getJDBConnection(); Statement stmt = conn.createStatement(); ResultSet rs = stmt.executeQuery(query)) {
            ...
            if (!hasData && currentPage > 1) {
                currentPage--; // Trở lại trang trước nếu không có dữ liệu
                JOptionPane.showMessageDialog(this, "Không còn dữ liệu để hiển thị.");
                loadPatients(currentPage); // Tải lại trang hợp lệ
            }
    ...
    private void btn_addActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_addActionPerformed
        AddPatient addForm = new AddPatient(this, userCode, userRole); // Pass parent, userCode, userRole
    ...
    private void btn_editActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_editActionPerformed
        ...
        try (Connection conn = DBConnect.DatabaseConnection.getJDBConnection(); PreparedStatement pstmt = conn.prepareStatement(query)) {
            ...
            if (rs.next()) {
                ...
                EditPatient editForm = new EditPatient(this, userCode, userRole, code, name, dob, gender, address, phone, email);
