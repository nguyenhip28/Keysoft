 ...
 * @author Vu Nguyen
 */
public class thuoc_manage extends javax.swing.JFrame {
    ...
    public thuoc_manage(javax.swing.JFrame parent, String userCode, String userRole) {
        this.parent = parent;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(thuoc_manage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new thuoc_manage().setVisible(true);
        });
    }
