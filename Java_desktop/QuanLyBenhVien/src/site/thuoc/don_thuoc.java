 ...
 * @author Vu Nguyen
 */
public class don_thuoc extends javax.swing.JFrame {
    ...
    public don_thuoc(javax.swing.JFrame parent, String userCode, String userRole) {
        this.parent = parent;
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(jLabel5)
                            .addComponent(lb_total, javax.swing.GroupLayout.PREFERRED_SIZE, 27, javax.swing.GroupLayout.PREFERRED_SIZE))))
        ...
        try (Connection conn = DatabaseConnection.getJDBConnection()) {
            ...
            if (rowInserted > 0) {
                ...
                if (generatedKeys.next()) {
                    ...
                    String insertDetailSql = "INSERT INTO prescription_details(prescription_id, medicine_id, quantity, dosage) VALUES (?, ?, ?, ?)";
                    PreparedStatement detailPs = conn.prepareStatement(insertDetailSql);

                    for (Map<String, String> thuoc : dsThuoc) {
                        int medicineId = Integer.parseInt(thuoc.get("medicine_id"));
                        String dosage = thuoc.get("dosage");
                        int quantity = 1;

                        detailPs.setInt(1, prescriptionId);
                        detailPs.setInt(2, medicineId);
                        detailPs.setInt(3, quantity);
                        detailPs.setString(4, dosage);
                        detailPs.addBatch();
                    }
        ...
        try (Connection conn = DatabaseConnection.getJDBConnection()) {
            ...
            if (rs.next()) {
                ...
                if (!patientCodeInput.equals(currentPatientCode)) {
                    ...
                    dsThuoc.clear();
                    display_don_thuoc.setText(""); // clear text hiển thị
                    totalAmount = 0.0;
                }
                ...
                // Cập nhật tổng tiền
                totalAmount = dsThuoc.stream().mapToDouble(t -> Double.valueOf(t.get("price"))).sum();
    ...
    private void btn_searchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_searchActionPerformed
        ...
        try (Connection conn = DatabaseConnection.getJDBConnection()) {
            ...
            if (rs.next()) {
                ...
                // Tìm chi tiết đơn thuốc
                String detailSql = "SELECT pd.*, m.medicine_name, m.price, m.unit FROM prescription_details pd JOIN medicines m ON pd.medicine_id = m.medicine_id WHERE pd.prescription_id = ?";
                ...
                while (detailRs.next()) {
                    Map<String, String> item = new HashMap<>();
                    item.put("medicine_id", String.valueOf(detailRs.getInt("medicine_id")));
                    item.put("medicine_name", detailRs.getString("medicine_name"));
                    item.put("dosage", detailRs.getString("dosage"));
                    item.put("price", String.valueOf(detailRs.getDouble("price")));
                    item.put("unit", detailRs.getString("unit"));
                    dsThuoc.add(item);

                    display_don_thuoc.append("Bệnh nhân:" + patientCodeInput + "\nTên thuốc: " + detailRs.getString("medicine_name")
                            + "\nLiều lượng: " + detailRs.getString("dosage")
                            + "\nĐơn vị: " + detailRs.getString("unit")
                            + "\nGiá: " + detailRs.getDouble("price") + "\n------------\n");
                }
    ...
    private void btn_refreshActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_refreshActionPerformed
        try (Connection conn = DatabaseConnection.getJDBConnection()) {
            ...
            display_don_thuoc.setText(""); // reset trước khi hiển thị
            ...
            while (rs.next()) {
                ...
                // Lấy chi tiết thuốc của đơn này
                String detailSql = "SELECT pd.*, m.medicine_name, m.price, m.unit FROM prescription_details pd JOIN medicines m ON pd.medicine_id = m.medicine_id WHERE pd.prescription_id = ?";
                PreparedStatement detailPs = conn.prepareStatement(detailSql);
                detailPs.setInt(1, prescriptionId);
                ResultSet detailRs = detailPs.executeQuery();
                ...
                while (detailRs.next()) {
                    String medName = detailRs.getString("medicine_name");
                    String dosage = detailRs.getString("dosage");
                    double price = detailRs.getDouble("price");
                    String unit = detailRs.getString("unit");

                    display_don_thuoc.append("  - Tên thuốc: " + medName + "\n - Liều lượng: " + dosage + "\n - Đơn vị: " + unit + ", \n - Giá: " + price + "\n");
                }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(don_thuoc.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
