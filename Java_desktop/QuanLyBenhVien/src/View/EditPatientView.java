...
public class EditPatientView extends javax.swing.JFrame {
    ...
    public EditPatientView(javax.swing.JFrame parent, String userCode, String userRole, PatientModel patient) {
        this.parent = parent;
    ...
    private void btn_editActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_editActionPerformed
        ...
        try {
            ...
            if (success) {
                ...
                if (parent != null) {
                    if (parent instanceof PatientView) {
                        ((PatientView) parent).reloadCurrentPage(); // gọi lại loadPatients()
                    }
